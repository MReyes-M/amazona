                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    <strong>Address: </strong>{order.shippingAddress.address}, {order.shippingAddress.city}, {order.shippingAddress.city},
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <ListGroup variant="flush">
                                    ...
                                    {!order.isPaid && (
                                        <ListGroup.Item key='paypalButton'>
                                            {isPending ? (
